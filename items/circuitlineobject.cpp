...
CircuitLineObject::CircuitLineObject(CircuitBaseObject *parent)
...
CircuitLineObject::~CircuitLineObject()
{

}

void CircuitLineObject::operator=(const CircuitLineObject &obj)
{
    mStartPos = obj.mStartPos;
    mEndPos = obj.mEndPos;
}

void CircuitLineObject::setStartPoint(const QPointF &sp)
{
    mStartPos= sp;
}

void CircuitLineObject::setEndPoint(const QPointF &ep)
{
    mEndPos = ep;
}

const QPointF &CircuitLineObject::startPoint() const
{
    return mStartPos;
}

const QPointF &CircuitLineObject::endPoint() const
{
    return mEndPos;
}

QRectF CircuitLineObject::boundingRect() const
{
...
QPainterPath CircuitLineObject::shape() const
{
    QPainterPath path;
...
void CircuitLineObject::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
