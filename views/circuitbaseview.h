...
class CircuitBaseView : public QGraphicsView
{
public:
    ...
    explicit CircuitBaseView(QWidget *parent = nullptr);
    explicit CircuitBaseView(QGraphicsScene *scene, QWidget *parent = nullptr);
